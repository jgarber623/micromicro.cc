...
micromicro.cc is written in [Ruby](https://www.ruby-lang.org) (version 3.1.2) and uses the [Bundler](https://bundler.io) gem to manage Ruby dependencies. Local development is done within a [Docker](https://docker.com) container running a custom-built image.
